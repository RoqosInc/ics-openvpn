...
import com.roqos.openvpnlib.core.VpnStatus.ByteCountListener;
import com.roqos.openvpnlib.core.VpnStatus.ConnectionStatus;
import com.roqos.openvpnlib.core.VpnStatus.StateListener;

import static com.roqos.openvpnlib.core.NetworkSpace.ipAddress;
import static com.roqos.openvpnlib.core.VpnStatus.ConnectionStatus.LEVEL_CONNECTED;
import static com.roqos.openvpnlib.core.VpnStatus.ConnectionStatus.LEVEL_CONNECTING_NO_SERVER_REPLY_YET;
import static com.roqos.openvpnlib.core.VpnStatus.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;

public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    public static final String START_SERVICE = "com.roqos.openvpnlib.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.roqos.openvpnlib.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.roqos.openvpnlib.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.roqos.openvpnlib.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "com.roqos.openvpnlib.PAUSE_VPN";
    private static final String RESUME_VPN = "com.roqos.openvpnlib.RESUME_VPN";
...
//            }
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.roqos.openvpnlib.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.roqos.openvpnlib.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.roqos.openvpnlib.VPN_STATUS");
