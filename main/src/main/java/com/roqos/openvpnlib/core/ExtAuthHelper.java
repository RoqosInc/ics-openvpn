...
import com.roqos.openvpnlib.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.roqos.openvpnlib.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.roqos.openvpnlib.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.roqos.openvpnlib.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.roqos.openvpnlib.api.KEY_DESCRIPTION";
