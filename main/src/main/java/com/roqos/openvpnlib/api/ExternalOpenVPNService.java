...
package com.roqos.openvpnlib.api;
...
import com.roqos.openvpnlib.core.ConfigParser;
import com.roqos.openvpnlib.core.ConfigParser.ConfigParseError;
import com.roqos.openvpnlib.core.OpenVPNService;
import com.roqos.openvpnlib.core.OpenVPNService.LocalBinder;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.roqos.openvpnlib.LaunchVPN.class);
                shortVPNIntent.putExtra(com.roqos.openvpnlib.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.roqos.openvpnlib.LaunchVPN.EXTRA_HIDELOG, true);
