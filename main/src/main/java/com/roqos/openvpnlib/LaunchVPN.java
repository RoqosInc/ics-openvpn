...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "com.roqos.openvpnlib.shortcutProfileUUID";
    public static final String EXTRA_NAME = "com.roqos.openvpnlib.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "com.roqos.openvpnlib.showNoLogWindow";
