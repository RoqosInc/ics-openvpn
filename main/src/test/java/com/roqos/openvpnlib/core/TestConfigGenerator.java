...
import static com.roqos.openvpnlib.VpnProfile.AUTH_RETRY_NOINTERACT;
import static com.roqos.openvpnlib.VpnProfile.TYPE_USERPASS;
...
public class TestConfigGenerator {
    ...
    public void testAuthRetryGen() throws PackageManager.NameNotFoundException {
        ...
        when(mc.getPackageName()).thenReturn("com.roqos.openvpnlib");
        when(mc.getPackageManager()).thenReturn(mpm);
        when(mpm.getPackageInfo(eq("com.roqos.openvpnlib"),eq(0))).thenReturn(mpi);*/
